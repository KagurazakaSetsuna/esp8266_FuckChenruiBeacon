...
const char ssids[] PROGMEM = {
  ...
  "kedarusaga hora guruguru mawatte\n"
  "watashi kara hanareru kokoro mo \n"
  "mienai wa sou shiranai?         \n"
  "jibun kara ugoku koto mo naku   \n"
  "tokinosukimaninagasare tsuzukete\n"
  "shiranai wa mawari no koto nado \n"
  "watashi wa watashi sore dake    \n"
  "yume miteru?  nanimo mitenai?   \n"
  "kataru momuda najibunnokotoba?  \n"
  "kanashimu nante tsukareru dakeyo\n"
  "nanimo kanjizu  sugoseba ii no  \n"
  "tomadou kotoba ataeraretemo     \n"
  "jibun nokokoro tada uwa no sora \n"
  "moshiwatashikara ugoku nonaraba \n"
  "subete kaeru no nara kuro nisuru\n"
  "muda najikan ni mirai wa aru no?\n"
  "konnatokoro niwatashi wa iru no?\n"
  "watashi no koto wo iitai naraba \n"
  "kotoba nisuru nonara:rokudenashi\n"
  "konnatokoroni watashi wa iru no?\n"
  "konna jikan niwatashi wa iru no?\n"
  "konna watashi mo kawareruno nara\n"
  "moshikawareruno narashironinaru?\n"
  "ima yume miteru? nanimo mitenai?\n"
  "katarumo muda najibun no kotoba?\n"
  "kanashimu nantetsukareru dake yo\n"
  "nanimo kanjizu  sugoseba ii no  \n"
  "tomadou kotoba  ataeraretemo    \n"
  "jibun no kokoro tada uwa no sora\n"
  "moshiwatashi karaugoku no naraba\n"
  "subetekaeru no nara kuro ni suru\n"
  "subetekowasu wa subete kowasu wa\n"
  "kanashimunaraba kanashimu naraba\n"
  "watashinokokoroshiroku kawareru?\n"
  "anatanokoto mo watashi no kotomo\n"
  "subeteno kotomo mada shiranai no\n"
  "omoi mabuta wo  aketa no naraba \n"
  "subetekowasuno nara kuroni nare!\n"
  "Adrenaline is pumping           \n"
  "Adrenaline is pumping           \n"
  "Generator. Automatic lover      \n"
  "Atomic. Atomic. Overdrive       \n"
  "Blockbuster. Brain power        \n"
  "Call me a leader.[REDACTED]     \n"
  "Don'tyou try it,don't you try it\n"
